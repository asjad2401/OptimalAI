...
async def generate_review_themes(data: ProductData) -> ReviewAnalysis:
    ...
    prompt_rules = (
        ...
        "its prevalence ('high', 'medium', 'low'), and actionable advice ('actionability').\n"
        "The 'actionability' field must tell the seller exactly what business or marketing action to take based on the theme.\n"
